...
service transmission stop 2&> /dev/null
...
wget http://github.itzmx.com/1265578519/transmission/master/4.0.0/transmission.sh -O /etc/init.d/transmission
chmod 755 /etc/init.d/transmission
chkconfig --add transmission
chkconfig --level 2345 transmission on
